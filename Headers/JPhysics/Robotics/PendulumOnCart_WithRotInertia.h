#ifndef __PENDULUM_ON_CART_WITH_ROT_INERTIA_H__
#define __PENDULUM_ON_CART_WITH_ROT_INERTIA_H__
...
class pendulum_on_cart_with_rot_inertia : public IEntityOld	//don't export the entire class (stl vectors won't work), just its functions
{
protected:
...
public:
	...
	JPHYSICS_API pendulum_on_cart_with_rot_inertia();
